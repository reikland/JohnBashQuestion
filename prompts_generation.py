...
def prompt_build_full(topic: str, proto: ProtoQuestion, start_d: date, end_d: date) -> Tuple[List[Dict[str, str]], str]:
  ...
  "ai_rationale": "Falsifiable, decision-relevant, clear data sources, no major ambiguity."
    ...
    user = (
        ...
        "Time rules:\n"
        "- Use UTC or Eastern Time for any time references; do not use local time.\n"
        ...
        "- Explicitly name AND, where possible, link to the primary sources or credible sources that determine the outcome.\n"
